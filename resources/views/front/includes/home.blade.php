            ...
            <div class="col-md-7">
                <div class="feature_article_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive top_static_article_img" src="{{URL::asset('front/img/feature-top.jpg')}}"
                             alt="feature-top">
                    </div>
                    <!-- feature_article_img -->
                            ...
                            <div class="col-md-6">
                                <div class="top_article_img">
                                    <a href="single.html" target="_self"><img class="img-responsive"
                                                                              src="{{URL::asset('front/img/cat-mobi-left-1.jpg')}}" alt="feature-top">
                                    </a>
                                </div>
                                <!----top_article_img------>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="category_article_body">
                                    <div class="top_article_img">
                                        <a href="single.html" target="_self"><img class="img-responsive" src="{{URL::asset('front/img/tab_top1.jpg')}}"
                                                                                  alt="feature-top">
                                        </a>
                                    </div>
                                    <!-- top_article_img -->
