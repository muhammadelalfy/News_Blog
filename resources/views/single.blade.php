...
<head>
    ...
    <!-- font-awesome -->
    <link href="{{URL::asset('front/fonts/font-awesome/font-awesome.min.css')}}" rel="stylesheet">
    <!-- Mobile Menu Style -->
    <link href="{{URL::asset('front/css/mobile-menu.css')}}" rel="stylesheet">
    ...
    <div class="container">
        <div class="header-section">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="logo">
                        <a href="index.html"><img src="{{URL::asset('front/img/logo.png')}}" alt="Tech NewsLogo"></a>
                    </div>
                    <!-- Logo Section -->
                </div>
                <div class="col-md-4">
...
<div class="related_news">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="media">
                <div class="media-left">
                    <a href="#"><img class="media-object" src="{{URL::asset('front/img/cat-mobi-sm1.jpg')}}"
            ...
            <div class="media">
                <div class="media-left">
                    <a href="#"><img class="media-object" src="{{URL::asset('front/img/cat-mobi-sm3.jpg')}}"
                                     alt="Generic placeholder image"></a>
                </div>
                <div class="media-body">
                    <span class="tag purple"><a href="category.html" target="_self">Mobile</a></span>
        ...
        <div class="col-md-6">
            <div class="media">
                <div class="media-left">
                    <a href="#"><img class="media-object" src="{{URL::asset('front/img/cat-mobi-sm2.jpg')}}"
                                     alt="Generic placeholder image"></a>
                </div>
                <div class="media-body">
                    <span class="tag purple"><a href="category.html" target="_self">Mobile</a></span>
            ...
            <div class="media">
                <div class="media-left">
                    <a href="#"><img class="media-object" src="{{URL::asset('front/img/cat-mobi-sm4.jpg')}}"
                                     alt="Generic placeholder image"></a>
                </div>
                <div class="media-body">
                    <span class="tag purple"><a href="category.html" target="_self">Mobile</a></span>
...
<div class="widget m30">
    ...
    <div class="widget_body"><img class="img-responsive left" src="{{URL::asset('front/img/editor.jpg')}}"
...
<div class="widget m30">
    ...
    <div class="widget_body"><img class="img-responsive left" src="{{URL::asset('front/img/reader.jpg')}}"
                                  alt="Generic placeholder image">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{URL::asset('front/img/editor_pic1.jpg')}}"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <h3 class="media-heading">
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{URL::asset('front/img/editor_pic2.jpg')}}"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <h3 class="media-heading">
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{URL::asset('front/img/editor_pic3.jpg')}}"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <h3 class="media-heading">
...
<!-- jquery Core-->
<script src="{{URL::asset('front/js/jquery-2.1.4.min.js')}}"></script>

<!-- Bootstrap -->
<script src="{{URL::asset('front/js/bootstrap.min.js')}}"></script>

<!-- Theme Menu -->
<script src="{{URL::asset('front/js/mobile-menu.js')}}"></script>
